...
**Demir kural:** Bot, bookmaker'ın güçlü favori gördüğü takıma (min %60 güven) makul fiyat aralığında (60-85¢) doğrudan giriş yapar. Edge hesabı yok. Stake, kazanma olasılığı ile orantılı (SPEC-016). Tüm exit kuralları, risk cap'leri, event guard ve manipulation/liquidity filter'ları korunur.

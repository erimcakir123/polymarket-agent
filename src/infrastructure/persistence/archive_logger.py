...
class ArchiveLogger:
    ...
    mirror_dir verilirse her kayit audit/ + session/ aynasina yazilir.
    """
    ...
    def __init__(self, archive_dir: str, mirror_dir: str | None = None) -> None:
    ...
    def _append(self, filename: str, record: BaseModel) -> None:
        ...
        if self.mirror is not None:
            with open(self.mirror / filename, "a", encoding="utf-8") as f:
                f.write(line)

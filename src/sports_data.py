...
_SPORT_LEAGUES: dict = {
    ...
    "uru": ("soccer", "uru.1", "Liga AUF Uruguaya"),
    ...
    "nga": ("soccer", "nga.1", "Nigerian Professional"),
    "gha": ("soccer", "gha.1", "Ghanaian Premier"),
    "tha": ("soccer", "tha.1", "Thai League 1"),
    "mys": ("soccer", "mys.1", "Malaysian Super League"),
    "idn": ("soccer", "idn.1", "Indonesian Super League"),
    "sgp": ("soccer", "sgp.1", "Singaporean Premier"),
    # ── Soccer — Other Europe (missing) ────────────────────────────────────
    "cyp": ("soccer", "cyp.1", "Cypriot First Division"),
    "irl1": ("soccer", "irl.1", "Irish Premier Division"),
    "sui": ("soccer", "sui.1", "Swiss Super League"),
    "pol": ("soccer", "pol.1", "Polish Ekstraklasa"),
    ...
    "elc": ("soccer", "eng.league_cup", "Carabao Cup"),
    "unl": ("soccer", "uefa.nations", "UEFA Nations League"),
    "afcl": ("soccer", "afc.champions", "AFC Champions League"),
    "ccup": ("soccer", "concacaf.champions", "Concacaf Champions Cup"),
    "cnl": ("soccer", "concacaf.nations.league", "Concacaf Nations League"),
    "cafcl": ("soccer", "caf.champions", "CAF Champions League"),
    # ── Tennis (tennis.md) ─────────────────────────────────────────────────
    "atp": ("tennis", "atp", "ATP"),
    "wta": ("tennis", "wta", "WTA"),
    # ── MMA (mma.md) ──────────────────────────────────────────────────────
...
_SERIES_TO_ESPN: dict = {
    ...
    # Soccer — additional series slugs
    "swiss-super-league": ("soccer", "sui.1"),
    "polish-ekstraklasa": ("soccer", "pol.1"),
    "czech-first-league": ("soccer", "cze.1"),
    "romanian-liga-i": ("soccer", "rou.1"),
    "ukrainian-premier-league": ("soccer", "ukr.1"),
    "croatian-football-league": ("soccer", "cro.1"),
    "colombian-primera-a": ("soccer", "col.1"),
    "peruvian-liga-1": ("soccer", "per.1"),
    "uruguayan-primera-division": ("soccer", "uru.1"),
    "ecuadorian-ligapro": ("soccer", "ecu.1"),
    "venezuelan-primera": ("soccer", "ven.1"),
    "paraguayan-primera": ("soccer", "par.1"),
    "indian-super-league": ("soccer", "ind.1"),
    "chinese-super-league": ("soccer", "chn.1"),
    "thai-league": ("soccer", "tha.1"),
    "malaysian-super-league": ("soccer", "mys.1"),
    "indonesian-liga-1": ("soccer", "idn.1"),
    "egyptian-premier-league": ("soccer", "egy.1"),
    "nigerian-professional-league": ("soccer", "nga.1"),
    "cypriot-first-division": ("soccer", "cyp.1"),
    "irish-premier-division": ("soccer", "irl.1"),
    ...
    "afc-champions-league": ("soccer", "afc.champions"),
    "caf-champions-league": ("soccer", "caf.champions"),
    "bolivian-primera-division": ("soccer", "bol.1"),
